#!/bin/bash
# Vivado Simulator launch script
E:/Xilinx/Vivado/2024.1/bin/xvlog.bat -timescale 1ns/1ps -i rtl/common \
...
E:/Xilinx/Vivado/2024.1/bin/xelab.bat -debug typical -timescale 1ns/1ps -top tb_top -snapshot tb_top_snapshot
E:/Xilinx/Vivado/2024.1/bin/xsim.bat tb_top_snapshot -runall
